...
class Text2SemanticDecoder(Text2SemanticDecoderBase):
    """Flash Attention implementation of GPT T2S decoder."""
    ...
    def __init__(self, config):
        ...
        # Re-wrap blocks with the correct T2STransformer subtype
        self.t2s_transformer = T2STransformer(
            self.num_layers, list(self.t2s_transformer.blocks))

    # Public alias — inference code calls process_batch_data
